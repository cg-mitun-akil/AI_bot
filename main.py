...
API_URL = 'https://api-inference.huggingface.co/models/abhi-8/'
past_user_inputs = []
past_generated_res = []
...
class MyClient(discord.Client):
  ...
  def query(self, payload):
    ...
    #past_user_inputs = past_user_inputs[-7:]
    #global past_generated_res
    #past_generated_res = past_generated_res[-7:]
  ...
  async def on_message(self, message):
    ...
    past_user_inputs.append(message.content)
    ...
    past_generated_res.append(bot_response)
...
def main():
  ...
  client = MyClient('DialoGPT-medium-Michael')
  keep_alive()
...
if __name__ == '__main__':
  main()
my_secret = os.environ['undefined']
import os
